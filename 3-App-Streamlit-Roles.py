...
with st.sidebar:
    ...
    if st.session_state.rol is None:
        ...
        if st.session_state.rol == "OFICINA_CENTRAL":
            ...
            menu = st.radio("Menú Oficina", ["📦 Crear Orden","📜 Compra y Guías", "📦 Órdenes Expedidas","📜 Compra y Guías". "✏️ Remisión/Factura", "⚙️ Catálogos Maestros", "🗺️ Seguimiento"], key="radio_menu_oficina")
